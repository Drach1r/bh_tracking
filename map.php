        ...
        <div class="filter-form">
            ...
            <div class="row">
                <div class="checkbox-group">
                    ...
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="lodging"> Lodging</label>
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="board"> Board</label>
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="bed_space"> Bed Space</label>
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="room_rent"> Room Rent</label>
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="house_rent"> House Rent</label>
                    ...
                    <label><input type="checkbox" class="bh_rates_charge rate-checkbox-group" value="other"> Others</label>
            ...
            <div class="row">
                <div class="checkbox-group">
                    ...
                    <label><input type="checkbox" class="light_ventilation light-checkbox-group" value="natural"> Natural</label>
                    <label><input type="checkbox" class="light_ventilation light-checkbox-group" value="artificial"> Artificial</label>
...
<script>
 $(document).ready(function () {
    ...
    // Filter markers based on input values
